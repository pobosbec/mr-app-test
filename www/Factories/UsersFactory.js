function UsersFactory($rootScope, $http, $timeout, apiFactory) {
    ...
    function getInboxUserDetails(token, inboxId, userIds, callback) {
        ...
        apiFactory.functions.call('inboxes/get-users', inboxUserDetailsRequest, function (response) {
    ...
    function getUser(appUserId,callback,error) {
        ...
        apiFactory.functions.call('users/details-for-user', appUserDetailsRequest, function (response) {
    ...
    function registerUser(instanceName, userName, password, callback, error) {
        ...
        apiFactory.functions.call('users/register', registerUserRequest, function(response) {
    ...
    function updateProfile(firstName,lastName,email,phone,avatar,callback,error) {
        ...
        apiFactory.functions.call('users/change-information', updateProfileRequest, function (response) {
            callback(response);
        }, function(e) {
            error(e);
        });
    ...
    function findUser(searchText, inboxId, callback, error) {
        ...
        apiFactory.functions.call('inboxes/search', findUserRequest, function (response) {
